              ...
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    If you haven&rsquo;t tried out Flaro App yet, I would
                    definitely recommend it for both designers and developers
                    &#x1F919;&#x1F3FB;
                  </p>
                </div>
                <div className="block">
            ...
            <div className="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    If you are thinking of a design partner to help you convert
                    more customers, Flaro is a great choice.
                  </p>
                </div>
                <div className="block">
                  <p className="text-sm text-gray-500 font-medium">
            ...
            <div className="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    We have built a few web apps using Flaro. It saves us a lot
                    of time, because we don&apos;t have to build design features
                    from scratch.
                  </p>
                </div>
                <div className="block">
            ...
            <div className="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    Wrike is great to make work visible and collaborative.
                    People can pass tasks off as they complete their parts,
                    allowing you to see the flow of work.
                  </p>
                </div>
                <div className="block">
                  <p className="text-sm text-gray-500 font-medium">
              ...
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    ...
                    the integrated marketing team to see all aspects of a
                    project.
                  </p>
                </div>
                <div className="block">
            ...
            <div className="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
              <div className="flex flex-col justify-between h-full">
                <div className="mb-5 block">
                  ...
                  <p className="text-lg font-medium">
                    Very very easy for customer information to get secured if
                    all orders are on one device.
                  </p>
                </div>
                <div className="block">
                  <p className="text-sm text-gray-500 font-medium">
